...
# so we downsize it.
if Main.flag_vr:
    Main.resolution.x = 128
    Main.resolution.y = 128
...
# --------------- Init system
print('line74 ___haoshuai___ initiating system')
hg.InputInit()
hg.WindowSystemInit()
...
# --------------------- Setup dogfight sim
print('line133 ___haoshuai___ start setup dogfight sim')
hg.AudioInit()
Main.init_game()
print("line136 ___haoshuai___ init game")
node = Main.scene.GetNode("platform.S400")
nm = node.GetName()

# rendering pipeline
print('line141 ___haoshuai___ start rendering pipline')
...
while not Main.flag_exit:
        ...
        if (not Main.flag_client_update_mode) or ((not Main.flag_renderless) and Main.flag_client_ask_update_scene):
            ...
            #     print("Frame________________________________________________________________________")
