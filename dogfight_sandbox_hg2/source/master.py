...
class Main:
    ...
    flag_display_machines_bounding_boxes = False #________IF TAKE BOUNDING BOXES__________
    ...
    def control_views(cls, keyboard):
        ...
        if keyboard.Down(hg.K_Numpad2):
            ...
            cls.player_view_mode = SmartCamera.TYPE_FPS
            cls.update_main_view_from_carousel()
    ...
    @classmethod
    def update(cls):
        # print("keyboard gui is", cls.flag_gui)
        if cls.flag_running:
        ...
        cls.wait_till_finish = True #by hs
