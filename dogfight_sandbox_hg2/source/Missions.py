...
# ============================= Basic fight
	...
	def mission_setup_players(cls, main):
		...
		n = len(main.players_allies)
		if n == 1:
			cls.aircrafts_starts_in_sky(main.players_ennemies, hg.Vec3(0, 1000, 0), hg.Vec3(1000, 500, 2000), hg.Vec2(-180, 180), hg.Vec2(800 / 3.6, 600 / 3.6))
			# cls.aircrafts_starts_on_carrier(main.players_allies, main.aircraft_carrier_allies[0], hg.Vec3(10, 19.5, 40), 0, hg.Vec3(0, 0, -20))
		elif n > 1:
...
# ============================ Client / Server mode
	...
	def network_mode_setup(cls, main):
		...
		file_name = "scripts/network_custom_config" + str(len(mission.allies)) + 'V' + str(len(mission.ennemies)) + ".json" #haoshuai
		...
		cls.setup_carriers(main.aircraft_carrier_allies, hg.Vec3(0, 0, 0), hg.Vec3(500, 0, 100), 0)
		cls.setup_carriers(main.aircraft_carrier_ennemies, hg.Vec3(-7000, 0, 0), hg.Vec3(500, 0, -150), radians(90))
		...
		n = len(main.players_allies)
		if n == 1:
			cls.aircrafts_starts_in_sky(main.players_allies, hg.Vec3(0, 1000, 0), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(0,0))# hg.Vec2(800 / 3.6, 600 / 3.6))#hg.Vec2(800 / 3.6, 600 / 3.6))  #haoshuai
			# cls.aircrafts_starts_on_carrier(main.players_allies, main.aircraft_carrier_allies[0], hg.Vec3(10, 19.5, 40), 0, hg.Vec3(0, 0, -20))   #haoshuai
		elif n == 2:
			cls.aircrafts_starts_in_sky(main.players_allies[0:n//2], hg.Vec3(0, 1000, 0), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))#hg.Vec2(800 / 3.6, 600 / 3.6))  #haoshuai
			cls.aircrafts_starts_in_sky(main.players_allies[n//2:n], hg.Vec3(200, 1000, 0), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))#hg.Vec2(800 / 3.6, 600 / 3.6))  #haoshuai
		elif n == 3:
			cls.aircrafts_starts_in_sky(main.players_allies[0:1], hg.Vec3(0, 1000, 0), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))#hg.Vec2(800 / 3.6, 600 / 3.6))  #haoshuai
			cls.aircrafts_starts_in_sky(main.players_allies[1:2], hg.Vec3(200, 1000, 0), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))#hg.Vec2(800 / 3.6, 600 / 3.6))  #haoshuai
			cls.aircrafts_starts_in_sky(main.players_allies[2:3], hg.Vec3(400, 1000, 0), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))#hg.Vec2(800 / 3.6, 600 / 3.6))  #haoshuai
		else:
			cls.aircrafts_starts_on_carrier(main.players_allies[0:n // 2], main.aircraft_carrier_allies[0], hg.Vec3(10, 19.5, 40), 0, hg.Vec3(0, 0, -20), 2, 2)
			cls.aircrafts_starts_on_carrier(main.players_allies[n // 2:n], main.aircraft_carrier_allies[0], hg.Vec3(-10, 19.5, 60), 0, hg.Vec3(0, 0, -20), 3, 2)
		...
		n = len(main.players_ennemies)
		if n == 1:
			cls.aircrafts_starts_in_sky(main.players_ennemies, hg.Vec3(0, 1000, 1500), hg.Vec3(0, 0, 0), hg.Vec2(-0, 0), hg.Vec2(0,0))#hg.Vec2(800 / 3.6, 600 / 3.6))
			# cls.aircrafts_starts_on_carrier(main.players_ennemies, main.aircraft_carrier_ennemies[0], hg.Vec3(10, 19.5, 40), 0, hg.Vec3(0, 0, -20)) #haohsuai
		elif n == 2:
			cls.aircrafts_starts_in_sky(main.players_ennemies[0:n//2], hg.Vec3(0, 1000, 1500), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
			cls.aircrafts_starts_in_sky(main.players_ennemies[n//2:n], hg.Vec3(200, 1000, 1500), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
		elif n == 3:
			cls.aircrafts_starts_in_sky(main.players_ennemies[0:1], hg.Vec3(0, 1000, 1500), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
			cls.aircrafts_starts_in_sky(main.players_ennemies[1:2], hg.Vec3(200, 1000, 1500), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
			cls.aircrafts_starts_in_sky(main.players_ennemies[2:3], hg.Vec3(400, 1000, 1500), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
		else:
	...
	def init(cls):
		...
		cls.missions.append(Mission("One on one", ["Rafale"], ["F16"], 1, 1, Missions.mission_setup_players, Missions.mission_one_against_x_end_test, Missions.mission_one_against_x_end_phase_update))
		cls.missions.append(Mission("Network mode", ["F16"], ["F16"], 1, 1, Missions.network_mode_setup, Missions.network_mode_end_test, Missions.network_mode_end_phase_update))
		cls.missions.append(Mission("Network mode 2v2", ["F16"]*2, ["F16"]*2, 1, 1, Missions.network_mode_setup, Missions.network_mode_end_test, Missions.network_mode_end_phase_update))
		cls.missions.append(Mission("Network mode 3v3", ["F16"]*3, ["F16"]*3, 1, 1, Missions.network_mode_setup, Missions.network_mode_end_test, Missions.network_mode_end_phase_update))
		...
		cls.missions.append(Mission("Fight against 3 ennemies", ["F16"] * 1 + ["F16"] * 2, ["F16"], 1, 1, Missions.mission_setup_players, Missions.mission_one_against_x_end_test, Missions.mission_one_against_x_end_phase_update))
		...
		cls.missions.append(Mission("Fight against 5 ennemies", ["F16"] * 5, ["F16"], 1, 1, Missions.mission_setup_players, Missions.mission_one_against_x_end_test, Missions.mission_one_against_x_end_phase_update))
		...
		# cls.missions.append(Mission("One on one hs", ["F16"], ["F16"], 1, 1, Missions.mission_setup_players, Missions.mission_one_against_x_end_test, Missions.mission_one_against_x_end_phase_update))
