                ...
                if collision["name"] == "front":
                    if len(collision["hits"]) > 0:
                        ...
                        if 0 < hit.t < raycast_length:
                            v_impact = hit.P - pos
                            if hg.Len(v_impact) < 10 * hg.Len(self.v_move) * dts: # it was 2, now is 10
...
class Aircraft(Destroyable_Machine):
    ...
    def get_thrust_level_dest(self): # by hs
        return self.thrust_level_dest
    ...
    def get_brake_level_dest(self): # by hs
        return self.brake_level_dest
    ...
    def get_flaps_level_dest(self):  # by hs
        return self.flaps_level_dest
    ...
    def get_roll_level_dest(self): # by hs
        return self.angular_levels_dest.z

    def get_pitch_level_dest(self):# by hs
        return self.angular_levels_dest.x

    def get_yaw_level_dest(self):# by hs
